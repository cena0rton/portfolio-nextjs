    ...
    <div id="about" className="mt-3 ">
      ...
      <div className='bg-neutral-50 rounded-lg'>
        ...
        >
         ...
         I follow simplicity, pay attention to details, and trust my intuition to structure things in a way that just feels right. I think differently, and that’s my strength.
          </p>
