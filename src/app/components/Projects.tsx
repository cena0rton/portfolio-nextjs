...
const projects = [
  ...
  },
  {
    ...
    description: 'Personalized skincare treatment platform.',
    image: '/formial-logo.webp', // You'll need to provide the actual image path
    alt: 'Formial',
    details: 'A comprehensive patient dashboard for Formial Labs, a personalized skincare treatment platform. The application enables users to manage their skincare journey through an intuitive interface featuring OTP-based authentication, multi-step onboarding with photo uploads, treatment plan tracking, subscription management, progress timeline visualization, and direct communication with dermatologists. Built with modern web technologies, it provides a seamless experience for patients to track their prescriptions, view treatment progress, manage orders, and access educational content through FAQs and social media integration.',
    tech: ['Next.js', 'React 19', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'REST API', 'Tabler Icons'],
    github: '',
    live: 'https://formial-demo-lzaq.vercel.app'
  },
  {
    title: 'Personalised Dietician App',
            ...
            <div className="p-8 max-h-[90vh] pb-10 md:mb-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                  ...
                  >
                    {selectedProject.title === "Formial Dashboard" ? (
                      <button
                        className="flex items-center gap-2 px-6 py-3 bg-neutral-300 text-neutral-700 rounded-lg cursor-not-allowed"
                        disabled
                        title="Access to source code is restricted"
                        type="button"
                      >
